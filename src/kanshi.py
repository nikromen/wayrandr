...
def update_kanshi_config(
    config: KanshiConfig, profile_name: str, new_output: OutputDirective
):
    """
    Updates the specified profile with a new output directive or adds the profile if it doesn't exist.
    """
...
new_output = OutputDirective(
    criteria="HDMI-A-1", directives=["enable", "mode 1920x1080@60Hz"]
)
